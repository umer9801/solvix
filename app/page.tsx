          ...
          <div className="animate-fade-in-down space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <a
                ...
                className="relative group bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground px-10 py-4 rounded-xl font-bold text-lg inline-flex items-center justify-center gap-2 transition-all duration-300 transform hover:scale-105 shadow-xl shadow-primary/30 hover:shadow-2xl hover:shadow-primary/50 overflow-hidden"
              >
              ...
              <Link
                href="/services"
                className="border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/20"
              >
                Explore Services
              </Link>
            </div>
